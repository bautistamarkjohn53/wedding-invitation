(function () {
    ...
    function openInvitation() {
        ...
        if (weddingCard) weddingCard.style.boxShadow = '0 40px 80px rgba(0,0,0,0.5), 0 0 0 2px rgba(201,168,76,0.35)';
    ...
    function closeInvitation() {
        ...
        if (weddingCard) weddingCard.style.boxShadow = '0 40px 80px rgba(0,0,0,0.6), 0 0 0 2px rgba(201,168,76,0.25)';
